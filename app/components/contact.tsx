...
const ContactPage = () => {
  ...
  return (
    <div className="container mx-auto p-6 text-center pt-20">
      ...
      <div className="max-w-md mx-auto p-6 bg-gradient-to-r from-yellow-300 to-yellow-500 rounded-lg shadow-lg text-black">
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {[1, 2, 3, 4, 5].map((star) => (
                  <span
                    ...
                    className={`cursor-pointer text-3xl transition-transform transform hover:scale-110 ${
                      star <= rating ? "text-gray-900" : "text-white"
                    }`}
                  >
                    ★
                  </span>
            ...
            <div className="flex justify-between">
              <button
                type="submit"
                className="w-full py-3 bg-gray-900 hover:bg-gray-600 rounded-md font-semibold text-white transition-colors"
              >
                Submit
              </button>
              <button
          ...
          <div>
            ...
            <button
              onClick={handleClear}
              className="mt-6 w-full py-3 bg-gray-900 hover:bg-gray-600 rounded-md font-semibold text-white transition-colors"
            >
              Kembali
            </button>
          </div>
