...
const Color: FC<ColorProps> = ({ setWarna }) => {
  return (
    <div className="container mx-auto p-6 text-center">
      <h1 className="text-3xl font-bold mb-6">Pilih Tema Warna</h1>
      <div className="flex justify-center space-x-4">
        ...
        <button
          className="px-6 py-3 bg-gradient-to-r from-gray-400 to-gray-500 text-white font-semibold rounded-lg shadow-md hover:scale-105 transform transition duration-300 ease-in-out"
          onClick={() => setWarna("gray")}
        >
          Gray
        </button>
      </div>
